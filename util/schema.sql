...
CREATE TABLE aukce(
  CisloAukce INT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE tag(
  IDTag INT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE objekt(
  IDobjektu INT GENERATED BY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
